...
//    index  - return the array element at the index, overrites the random param
//
exports.getProperty = function (list, propChain, random, index) {
...
//
exports.getSubPropFromBody = function(body, chain) {
  var json = this.parseJson(body);
  
  if (!json) return false;
  
  return exports.getSubProp(json, chain)
}
...
//
// print the names of the tests being executed in order
//
exports.printSet = function(set) {
  for (test in set) {
    console.log('\n' + test.name);
  }
}
...
exports.printValues = function (obj) {
  console.log('values:');
